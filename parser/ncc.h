...
static int ra_vmax;
void buf_new(int type, char* dat, long dlen);
void printMem(char* cs, long cslen);
...
void out_write(char *cs, long cslen, char* out, long* out_len);
void o_write(char* out, long* out_length);
